...
const pages = () => {
    return (
        <>
            <Image src={img} alt="Hockey" layout="responsive" priority={true} />
            <div className="text-center">
                <h2>Registration Form</h2>
                <form action="show_data.html" method="get" >
                    <Row>
                        <Col> <label htmlFor="get-name">First Name:</label>
                            <input id="get-name" type="text" name="name" /></Col>
                        <Col><label htmlFor="get-lastname">Last Name:</label>
                            <input id="get-lastname" type="text" name="lastname" /></Col>
                        <Col><label htmlFor="get-street">Street Address</label>
                            <input id="get-street" type="text" name="street" /></Col>
                        <Col> <label htmlFor="get-city">City:</label>
                            <input id="get-city" type="text" name="city" /></Col>
                        <Col><label htmlFor="get-code">Zid Code:</label>
                            <input id="get-code" type="text" name="code" /></Col>
                        <Col> <label htmlFor="get-birthdate">Birthdate(mm/ddyyyy): </label>
